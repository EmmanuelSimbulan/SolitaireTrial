...
//                                        // Always get the last card in the target column
                            ...
                            for (int j = 0; j < tableau.size(); j++) {
                                if (i != j) {
                                    ...
                                    if (targetColumn.isEmpty() && topCard.getRank() == Rank.KING) {
                                        ...
                                        updated = true;
                                        moves++;
                                        System.out.println("Moved " + topCard + " to Column " + (j + 1));
                                        CardMovementHandler.logCardMovement(topCard, "Column", j + 1);
                                        break;
                                    } else if (!targetColumn.isEmpty()) {
                                        Card targetTopCard = targetColumn.peekLast();

                                        System.out.println("Trying to move " + topCard + " to " + targetTopCard + " in Column " + (j + 1));
